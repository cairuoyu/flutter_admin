...
class MenuApi {
  static Future<ResponeBodyApi> list(data) async {
    ResponeBodyApi responeBodyApi = await HttpUtil.post('/menu/list', data: data, requestToken: false);
    
    return responeBodyApi;
  }

  static Future<ResponeBodyApi> saveOrUpdate(data) async {
    ResponeBodyApi responeBodyApi = await HttpUtil.post('/menu/saveOrUpdate', data: data, requestToken: false);
    return responeBodyApi;
  }
